...
export const AgentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="nooSphereHubApp.nooSphereHubAgent.delete.question">
        <Translate contentKey="nooSphereHubApp.nooSphereHubAgent.delete.question" interpolate={{ id: agentEntity.id }}>
