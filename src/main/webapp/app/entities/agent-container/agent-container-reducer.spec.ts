...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENTCONTAINER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENTCONTAINER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENTCONTAINER actions', async () => {
      const arg = { id: 'fdbbc0b9-e04b-4677-9512-e152dba0ac37' };
    ...
    it('dispatches UPDATE_AGENTCONTAINER actions', async () => {
      const arg = { id: 'fdbbc0b9-e04b-4677-9512-e152dba0ac37' };
    ...
    it('dispatches PARTIAL_UPDATE_AGENTCONTAINER actions', async () => {
    ...
    it('dispatches DELETE_AGENTCONTAINER actions', async () => {
      const arg = 42666;
