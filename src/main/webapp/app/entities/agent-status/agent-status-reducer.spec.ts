...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENTSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENTSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENTSTATUS actions', async () => {
      const arg = { id: 'c99f66ae-bc48-487a-888b-a6196b27bd12' };
    ...
    it('dispatches UPDATE_AGENTSTATUS actions', async () => {
      const arg = { id: 'c99f66ae-bc48-487a-888b-a6196b27bd12' };
    ...
    it('dispatches PARTIAL_UPDATE_AGENTSTATUS actions', async () => {
    ...
    it('dispatches DELETE_AGENTSTATUS actions', async () => {
      const arg = 42666;
