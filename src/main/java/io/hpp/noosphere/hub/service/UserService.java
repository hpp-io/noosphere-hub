...
public class UserService {
  ...
  @Transactional(readOnly = true)
  public Optional<User> findOptionalByWalletAddressAndEmail(String walletAddress, String email, Boolean activated) {
    return userRepository.findOneByWalletAddressAndEmail(walletAddress, email, activated);
  }

  @Transactional(readOnly = true)
  public Optional<User> findOptionalByWalletAddress(String walletAddress, Boolean activated) {
    return userRepository.findOneByWalletAddress(walletAddress, activated);
  }

  public UserDTO findOneByWalletAddressAndEmail(String walletAddress, String email, Boolean activated) {
    Optional<User> optionalUser = this.findOptionalByWalletAddressAndEmail(walletAddress, email, activated);
    return optionalUser.map(userMapper::userToUserDTO).orElse(null);
  }

  public UserDTO findOneByWalletAddress(String walletAddress, Boolean activated) {
    Optional<User> optionalUser = this.findOptionalByWalletAddress(walletAddress, activated);
    return optionalUser.map(userMapper::userToUserDTO).orElse(null);
  }
