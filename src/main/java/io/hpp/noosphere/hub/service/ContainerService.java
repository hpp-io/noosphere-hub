...
import io.hpp.noosphere.hub.exception.ContainerNotFoundException;
...
public class ContainerService {
    ...
    public ContainerService(ContainerRepository containerRepository, ContainerMapper containerMapper, UserService userService) {
        this.containerRepository = containerRepository;
        this.containerMapper = containerMapper;
        this.userService = userService;
    }

    public Container validateOwner(UUID id, String userId) throws PermissionDeniedException, ContainerNotFoundException {
        Container container = containerRepository.findById(id).orElseThrow(() -> new ContainerNotFoundException(id.toString()));
    ...
    public ContainerDTO partialUpdate(UserService userService, String userId, ContainerDTO containerDTO, Instant timestamp)
        throws PermissionDeniedException, ContainerNotFoundException {
    ...
    public Page<ContainerDTO> search(
        ...
        return containerRepository
            .search(searchText, name, statusCode, createdByUserId, walletAddress, pageable)
     ...
     * @param id the id of the entity.
     */
    public void delete(String userId, UUID id) throws PermissionDeniedException, ContainerNotFoundException {
    ...
    public ContainerDTO updateStatus(UUID id, StatusCode statusCode, Instant timestamp) throws ContainerNotFoundException {
