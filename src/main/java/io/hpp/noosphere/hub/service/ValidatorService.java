...
public class ValidatorService {
    ...
    public ValidatorService(ValidatorRepository validatorRepository, ValidatorMapper validatorMapper, UserService userService) {
        this.validatorRepository = validatorRepository;
        this.validatorMapper = validatorMapper;
        this.userService = userService;
    }

    public Validator validateOwner(UUID id, String userId) throws PermissionDeniedException, ValidatorNotFoundException {
        Validator validator = validatorRepository.findById(id).orElseThrow(() -> new ValidatorNotFoundException(id.toString()));
    ...
    public Page<ValidatorDTO> search(
        String searchText,
        String name,
     ...
     * @param id the id of the entity.
     */
    public void delete(String userId, UUID id) throws PermissionDeniedException, ValidatorNotFoundException {
    ...
    public ValidatorDTO updateStatus(UUID id, StatusCode statusCode, Instant timestamp) throws ValidatorNotFoundException {
