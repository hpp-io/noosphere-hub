    ...
    private OAuth2AuthorizedClient getTestOAuth2AuthorizedClient(boolean accessTokenExpired) {
        ...
        return new OAuth2AuthorizedClient(
            ClientRegistration.withRegistrationId(VALID_REGISTRATION_ID)
                ...
                .authorizationUri("http://localhost:8085/auth/realms/master/protocol/openid-connect/auth")
                .tokenUri("https://localhost:8085/auth/realms/master/protocol/openid-connect/token")
                .build(),
            "sub",
            token,
